## 1. Backend Statistics
- [x] 1.1 Add a service method that aggregates task counts and completion percentage on the server.
- [x] 1.2 Add `GET /api/todos/statistics` with the required DTO contract.
