...
## Why
Teams need more than a binary todo/done toggle. Tasks often move through in-progress and in-review before they are done, and the API must reject invalid status values so client and server stay aligned.

## What Changes
- Expand allowed todo statuses to: `todo`, `in-progress`, `in-review`, `done`
...
- Partner split: server work and client work on branches off this shared feature branch
